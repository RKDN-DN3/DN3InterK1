        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDelete = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false, defaultValue: "0"),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserCreate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UserUpdate = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_List_Question_In_Exams", x => new { x.Id_Exam, x.Id_Question });
                    table.ForeignKey(
                        name: "FK_List_Question_In_Exams_Examinations_Id_Exam",
                        column: x => x.Id_Exam,
                        principalTable: "Examinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_List_Question_In_Exams_Questions_Id_Question",
                        column: x => x.Id_Question,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_List_Question_In_Exams_Id_Question",
                table: "List_Question_In_Exams",
                column: "Id_Question");
